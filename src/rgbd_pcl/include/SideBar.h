#pragma once
#define SIDEBAR_WIDTH 0.015
#define SIDEBAR_HEIGBT 0.06
...
namespace vision_exchanger
{
    ...
    public:
        ...
        image_transport::CameraSubscriber FC_sub;

        SideBar(const ros::NodeHandle& nh);
        ~SideBar();
        ...
        //初始化并启动订阅
        void initialization();
        void FC_CB(const sensor_msgs::ImageConstPtr& image_msg,
    ...
    private:
        ...
        // 独立回调队列，让FC_CB在单独线程跑
        ros::CallbackQueue fc_queue_;
        std::shared_ptr<std::thread> fc_spinner_thread_;
        std::atomic<bool> fc_spinner_running_{false};
