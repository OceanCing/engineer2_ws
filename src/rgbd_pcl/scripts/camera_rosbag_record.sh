...
do 
        ...
        do
                rosbag record -q -b 2048 --duration=300 -O "$FILEINDEX" -e "/gemini_336l/depth/points$" "/gemini_336l/depth/camera_info$" "/gemini_336l/color/image_raw/compressed$" "/gemini_336l/color/camera_info$" "/tf$" "/tf_static$"
