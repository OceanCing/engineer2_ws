...
class ClearSlaveManagerRosBase : public SlaveManagerType {
 public:
  ClearSlaveManagerRosBase(bool standalone, bool installSignalHandler, double timeStep, ros::NodeHandle& nh, std::string& rosPrefix);
...
#include "rm_ecat_ros/ClearSlaveManagerRosBaseImpl.h"
