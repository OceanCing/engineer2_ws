...
#include "rm_ecat_mit/ConfigurationParser.h"
...
bool getValueFromFile(YAML::Node& yamlNode, const std::string& varName, T& var) {
  if (!yamlNode[varName].IsDefined()) {
    MELO_WARN_STREAM("[rm_ecat::mit::ConfigurationParser::getValueFromFile]: field '" << varName << "' is missing. Default value will be used.");
    return false;
  }
  try {
    ...
    MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getValueFromFile] Error while parsing value \"" << varName
...
ConfigurationParser::ConfigurationParser(const std::string& filename) {
  ...
  try {
    ...
    MELO_FATAL_STREAM("[rm_ecat::mit::ConfigurationParser::ConfigurationParser] Loading YAML configuration file '" << filename << "' failed.");
  }
  ...
  if (configNode["can_motors"].IsDefined()) {
    ...
    for (YAML::const_iterator it = motors.begin(); it != motors.end(); ++it) {
      ...
      if (bus == 0) {
        ...
        MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::parseConfiguration] Unknown can bus");
      }
    }
  }
...
uint16_t ConfigurationParser::getMaxOut(MotorType motorType) {
  switch (motorType) {
    ...
    case MotorType::DM8009:
      return 2048;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getMaxOut] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getTorqueOffset(rm_ecat::mit::MotorType motorType) {
  switch (motorType) {
    case MotorType::DM4310:
    case MotorType::HT8115:
      return -18.0;
    ...
    case MotorType::DM8009:
      return -54.0;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getTorqueOffset] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getPositionOffset(rm_ecat::mit::MotorType motorType) {
  switch (motorType) {
    case MotorType::DM4310:
      return -12.56;
    case MotorType::DM4340:
    ...
    case MotorType::HT8115:
      return -95.5;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getPositionOffset] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getVelocityOffset(rm_ecat::mit::MotorType motorType) {
  switch (motorType) {
    case MotorType::DM4310:
    case MotorType::DM8009:
    case MotorType::HT8115:
    ...
    case MotorType::DM4340:
      return -5.44;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getVelocityOffset] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getKpFactorToInteger(rm_ecat::mit::MotorType motorType){
  switch (motorType) {
    case MotorType::DM4310:
    case MotorType::DM4340:
    case MotorType::HT8115:
    case MotorType::DM8009:
      return 8.19;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getKpFactorToInteger] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getKdFactorToInteger(rm_ecat::mit::MotorType motorType){
  switch (motorType) {
    case MotorType::DM4310:
    case MotorType::DM4340:
    case MotorType::HT8115:
    case MotorType::DM8009:
      return 819.;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getKdFactorToInteger] Unknown motor type");
      return 0;
  }
}
...
double ConfigurationParser::getTorqueFactorIntegerToNm(MotorType motorType) {
  switch (motorType) {
    ...
    case MotorType::DM8009:
      return 54. * 2. / 4095;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getTorqueFactorIntegerToNm] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getPositionFactorIntegerToRad(rm_ecat::mit::MotorType motorType){
  switch (motorType) {
    case MotorType::DM4310:
    ...
    case MotorType::HT8115:
      return 95.5 * 2. / 65536;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getPositionFactorIntegerToRad] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getVelocityFactorIntegerPerMinusToRadPerSec(rm_ecat::mit::MotorType motorType){
  switch (motorType) {
    case MotorType::DM4310:
    case MotorType::HT8115:
    case MotorType::DM8009:
    ...
    case MotorType::DM4340:
      return 5.44 * 2. / 4095;
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getVelocityFactorIntegerPerMinusToRadPerSec] Unknown motor type");
      return 0;
  }
}
...
double ConfigurationParser::getTorqueFactorNmToInteger(MotorType motorType) {
  switch (motorType) {
    ...
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getTorqueFactorNmToInteger] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getPositionFactorRadToInteger(rm_ecat::mit::MotorType motorType){
  switch (motorType) {
    case MotorType::DM4310:
    case MotorType::DM4340:
    case MotorType::HT8115:
    ...
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getPositionFactorRadToInteger] Unknown motor type");
      return 0;
  }
}

double ConfigurationParser::getVelocityFactorRadPerSecToInteger(rm_ecat::mit::MotorType motorType){
  switch (motorType) {
    case MotorType::DM4310:
    case MotorType::DM4340:
    case MotorType::HT8115:
    ...
    default:
      MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getVelocityFactorRadPerSecToInteger] Unknown motor type");
      return 0;
  }
}
...
MotorType ConfigurationParser::getMotoTypeFromString(const std::string& motorTypeString) {
  if (motorTypeString == "DM4310") {
    ...
    MELO_ERROR_STREAM("[rm_ecat::mit::ConfigurationParser::getMotoTypeFromString] Unknown motor type");
    return MotorType::DM4310;
  }
}
}  // namespace mit
