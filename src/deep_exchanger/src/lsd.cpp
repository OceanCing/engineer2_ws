                         ...
                         int ** reg_img, int * reg_x, int * reg_y )
{
  ...
  double sigma_scale = 0.6; /* Sigma for Gaussian filter is computed as
                                sigma = sigma_scale/scale.   default=0.6      */
  double quant = 2.5;       /* Bound to the quantization error on the
                                gradient norm.   default=2.0                  */
  double ang_th = 20.5;     /* Gradient angle tolerance in degrees.  default=22.5      */
 ...
 */
double *lsd(int *n_out, double *img, int X, int Y, int *pInt) {
  /* LSD parameters */
